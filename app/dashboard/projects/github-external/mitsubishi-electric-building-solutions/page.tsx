...
const PROJECT_ID = "github-external-mitsubishi";
const COMPANY_NAME = "三菱電機ビルソリューションズ";

export default function MitsubishiElectricProjectPage() {
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        {displayTasks.length === 0 ? (
          ...
          <div className="border rounded-lg">
            {/* WBS 表示は省略しているが、必要なら追加できます */}
            <div className="p-4 text-sm text-gray-500">WBS 表示</div>
          </div>
        )}
      </div>
    </div>
