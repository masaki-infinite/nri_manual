...
const PROJECT_ID = "github-external-tele-marker";
const COMPANY_NAME = "テレ・マーカーグループ株式会社";

export default function TeleMarkerProjectPage() {
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-gray-600 ml-2">工数: {task.hours || 0}h</span>
                      </div>
                    </div>
