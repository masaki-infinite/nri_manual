...
const PROJECT_ID = "github-group-nri-secure";
const COMPANY_NAME = "NRIセキュア";

export default function NRISecureProjectPage() {
  ...
  useEffect(() => {
    ...
    // メモを読み込む
    const storedMemo = localStorage.getItem(`project_${PROJECT_ID}_${COMPANY_NAME}_memo`);
    if (storedMemo) {
      setMemo(storedMemo);
    }
