...
const PROJECT_ID = "snowflake-external";
const PROJECT_NAME = "Snowflake外販";

export default function SnowflakeExternalProjectPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        <h2 className="text-3xl font-bold text-gray-800">❄️ {PROJECT_NAME}</h2>
        {!isEditingAssignee ? (
          <button
