      ...
      subItems: [
        ...
        },
        {
          ...
          subItems: [
            ...
            { name: "モデル一覧", href: "/training/claude-code/models" },
            { name: "Opus 4.8", href: "/training/claude-code/models/opus-4-8" },
            { name: "Fable 5", href: "/training/claude-code/models/fable" },
          ],
        },
        {
          name: "IDE",
        ...
        { name: "NotebookLM", href: "/training/notebooklm" },
        {
          ...
          subItems: [
            ...
            { name: "Snowflake Adaptor", href: "/training/snowflake/adaptor" },
            { name: "Snowflake Intelligence", href: "/training/snowflake/intelligence" },
